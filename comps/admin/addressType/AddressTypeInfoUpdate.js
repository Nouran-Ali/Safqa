...
import { createAddressType, ResetSuccess, updateAddressType } from "../../../store/slices/addressTypeSlice";
...
const AddressTypeInfoUpdate = ({ addressTypeInfo }) => {
  ...
  const onSubmit = (data) => dispatch(updateAddressType(data));
...
export default AddressTypeInfoUpdate;
