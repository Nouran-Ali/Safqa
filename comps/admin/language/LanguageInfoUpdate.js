...
import { createLanguage, ResetSuccess, updateLanguage } from "../../../store/slices/languageSlice";

const LanguageInfoUpdate = ({ languageInfo }) => {
  ...
  const onSubmit = (data) => dispatch(updateLanguage(data));
