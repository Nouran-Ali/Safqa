...
import { createBank, ResetSuccess, updateBank } from "../../../store/slices/bankSlice";

const AdminBankInfoUpdate = ({ bankInfo }) => {
  ...
  const onSubmit = (data) => dispatch(updateBank(data));
...
export default AdminBankInfoUpdate;
