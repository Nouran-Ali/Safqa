...
import { createBusinessCategory, ResetSuccess } from "../../../store/slices/businessCategorySlice";
...
const BusinessCategoryInfo = () => {
  ...
  const { businessCategoryInfo, isLoading, api_errors, success } = useSelector(
  ...
  const onSubmit = (data) => dispatch(createBusinessCategory(data));
...
export default BusinessCategoryInfo;
