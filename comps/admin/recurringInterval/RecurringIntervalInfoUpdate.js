...
import { ResetSuccess, updateRecurringInterval } from "../../../store/slices/recurringIntervalSlice";
import { useTheme } from "next-themes";
import { createRecurringIntervalSchemaAr } from "../../../lib/validations/ar/recurringIntervalSchemaAr";

const RecurringIntervalInfoUpdate = ({ recurringIntervalInfo }) => {
  ...
  useEffect(() => {
    success && dispatch(ResetSuccess()) && router.push("/dashboard/admin/recurringInterval")
  }, [success]);

  const onSubmit = (data) => dispatch(updateRecurringInterval(data));
...
export default RecurringIntervalInfoUpdate;
