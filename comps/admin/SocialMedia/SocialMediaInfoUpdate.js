...
import { ResetSuccess, updateSocialMedia } from "../../../store/slices/socialMediaSlice";
import { createSocialMediaSchema, updateSocialMediaSchema } from "../../../lib/validations/en/socialMediaSchema";
import { useTheme } from "next-themes";
import { createSocialMediaSchemaAr, updateSocialMediaSchemaAr } from "../../../lib/validations/ar/socialMediaSchemaAr";

const SocialMediaInfoUpdate = ({ socialMediaInfo }) => {
  ...
  const {
    ...
    resolver: yupResolver(language == 'en' ? updateSocialMediaSchema : updateSocialMediaSchemaAr),
    defaultValues,
  });
  ...
  const onSubmit = (data) => dispatch(updateSocialMedia(data));
...
export default SocialMediaInfoUpdate;
