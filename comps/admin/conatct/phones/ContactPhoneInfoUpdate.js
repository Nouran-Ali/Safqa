...
import { createContactPhone, ResetSuccess, updateContactPhone } from "../../../../store/slices/contactPhoneSlice";

const ContactPhoneInfoUpdate = ({ contactPhoneInfo }) => {
  ...
  const onSubmit = (data) => dispatch(updateContactPhone(data));
...
export default ContactPhoneInfoUpdate;
