...
import { createSupportType, ResetSuccess } from "../../../../store/slices/supportTypeSlice";
...
const SupportTypeInfo = () => {
  ...
  const { supportTypeInfo, isLoading, api_errors, success } = useSelector(
  ...
  const onSubmit = (data) => dispatch(createSupportType(data));
...
export default SupportTypeInfo;
