...
import { createAdmin, ResetSuccess, updateAdmin } from "../../../store/slices/adminSlice";
import { updateAdminSchema } from "../../../lib/validations/en/adminScehma";
import { updateAdminSchemaAr } from "../../../lib/validations/ar/adminScehmaAr";

const AdminUpdateInfo = ({ register, errors, api_errors }) => {
