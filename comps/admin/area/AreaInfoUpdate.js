...
import { createArea, ResetSuccess, updateArea } from "../../../store/slices/areaSlice";
...
const AreaInfoUpdate = ({ areaInfo }) => {
  ...
  useEffect(() => { setValue('city_id', areaInfo.city_id) }, [areaInfo.city_id, setValue])

  const onSubmit = (data) => dispatch(updateArea(data));
