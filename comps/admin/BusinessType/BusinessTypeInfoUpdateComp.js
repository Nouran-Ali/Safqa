...
import { createBusinessTypeSchema, updateBusinessTypeSchema } from "../../../lib/validations/en/businessTypeSchema";
import { createBusinessTypeSchemaAr, updateBusinessTypeSchemaAr } from "../../../lib/validations/ar/businessTypeSchemaAr";
import { ResetSuccess, updateBusinessType } from "../../../store/slices/businessTypeSlice";

const BusinessTypeInfoUpdateComp = ({ businessTypeInfo }) => {
    ...
    const {
        ...
        resolver: yupResolver(language == 'en' ? updateBusinessTypeSchema : updateBusinessTypeSchemaAr),
        defaultValues,
    });
    ...
    const onSubmit = (data) => dispatch(updateBusinessType(data));
...
export default BusinessTypeInfoUpdateComp;
